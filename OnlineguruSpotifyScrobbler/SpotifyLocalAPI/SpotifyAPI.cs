...
namespace JariZ
{
    public class SpotifyAPI
    {
        ...
        public SpotifyAPI(string OAuth, string Host)
        {
            ...
            if (!CFID)
            {
                throw new Exception("Could not get CFID from SpotifyAPI.");
            }
        }
        ...
        public static string GetOAuth()
        {
            ...
            string raw = client.DownloadString("https://open.spotify.com/token");
        ...
        private string recv(string request, bool oauth = false, bool cfid = false, int wait = -1)
        {
